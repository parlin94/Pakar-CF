...
class Relasi_model extends CI_Model
{
    ...
    {
        $sql = "select distinct diagnosa_id,p.kode_diagnosa,p.nama_diagnosa,p.keterangan from relasi r inner join diagnosa p on r.diagnosa_id=p.id where gejala_id in (" . $gejala . ") order by diagnosa_id,gejala_id";
